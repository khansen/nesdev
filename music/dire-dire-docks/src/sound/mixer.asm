...
.ifndef NO_SFX
  ...
  +
.endif
    lda mixer.envelopes[0].vol
    lsr : lsr : lsr : lsr
    sta mixer.envelopes[0].scaled_vol
.ifndef NO_MUTABLE_CHANNELS
    lda sound_status
    lsr
.endif
...
.endif
    and #$F0
    ora mixer.envelopes[0].scaled_vol
    tay
    lda volume_table,y
...
.ifndef NO_SFX
  ...
  +
.endif
    lda mixer.envelopes[1].vol
    lsr : lsr : lsr : lsr
    sta mixer.envelopes[1].scaled_vol
.ifndef NO_MUTABLE_CHANNELS
    lda sound_status
    lsr
    lsr
...
.endif
    and #$F0
    ora mixer.envelopes[1].scaled_vol
    tay
    lda volume_table,y
    ora mixer.master_vol
    tay
...
.ifndef NO_SFX
  ...
  +
.endif
    lda mixer.envelopes[2].vol
    lsr : lsr : lsr : lsr
    sta mixer.envelopes[2].scaled_vol
.ifndef NO_MUTABLE_CHANNELS
    lda sound_status
    lsr
    lsr
...
.endif
    and #$F0
    ora mixer.envelopes[2].scaled_vol
    tay
    lda volume_table,y
    ora mixer.master_vol
    tay
...
.ifndef NO_SFX
 ++ lda mixer.sfx[3].ptr.hi
  ...
  +
.endif
    lda mixer.envelopes[3].vol
    lsr : lsr : lsr : lsr
    sta mixer.envelopes[3].scaled_vol
.ifndef NO_MUTABLE_CHANNELS
    lda sound_status
    lsr
    lsr
...
.endif
    and #$F0
    ora mixer.envelopes[3].scaled_vol
    tay
    lda volume_table,y
    ora mixer.master_vol
    tay
