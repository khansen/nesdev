...
.proc effect_tick
    ...
    jsr table_call
TC_SLOT null_tick         ; 0
TC_SLOT slide_up_tick     ; 1
TC_SLOT slide_down_tick   ; 2
TC_SLOT portamento_tick   ; 3
TC_SLOT vibrato_tick      ; 4
TC_SLOT arpeggio_tick     ; 5
TC_SLOT volume_slide_tick ; 6
TC_SLOT tremolo_tick      ; 7
TC_SLOT cut_tick          ; 8
TC_SLOT pulsemod_tick     ; 9
.endp
